#Prob1 Cost to ship
'''A shipping company charges its customer based on the weight of goods and the distance of
...
weight = float(input(" Weight of your shipping? "))
distance = float(input(" Distance of shipping? "))
basePrice = float(input("The the base price? "))

#get the discount using an if-else statement
if distance < 250:
    discount = 0.0
